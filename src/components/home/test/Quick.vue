<template>
  <div>
    <h5 class="my-3">Quick Overview</h5>
    <div class="quick">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="total-modules total d-flex flex-column justify-content-between p-2">
                ...
                <h5 class="text-white">Total Modules</h5>
              </div>
            </div>
            <div class="col-md-6">
              <div
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-6">
              ...
              >
                ...
                <h5 class="text-white">Total Failed</h5>
              </div>
            </div>
          </div>
          <div class="row mt-3">
            ...
            <div class="col-md-6">
              ...
              >
                ...
                <h5 class="text-white">Total Untested</h5>
              </div>
            </div>
          </div>
        </div>
...
.failed {
  background-color: #f8426e;
}
.passed {
  background-color: #4dbd98;
}
.untested {
  background-color: #3d43a2;
}
.total-modules {
  height: 10rem;
  width: 100%;
